...
<strong style="font-size:16px;"><?php echo $faq->getQuestion() ?></strong>&nbsp;&nbsp;<span class="faded"><?php echo $faq->isPublished()?'(Опубликован)':''; ?></span>
</div>
<div style="float:right;text-align:right;padding-top:5px;padding-right:5px;">
<?php
if($thisstaff->canManageFAQ()) {
    echo sprintf('<a href="faq.php?id=%d&a=edit" class="Icon newHelpTopic">Изменить</a>',
            $faq->getId());
}
?>
&nbsp;
...
<p>
 ...
 <div><span class="faded"><b>Тема обращения:</b></span> 
	 ...
	 <?php csrf_token(); ?>
        ...
        <div>
            ...
            <select name="a" style="width:200px;">
                ...
                <?php
                if($faq->isPublished()) { ?>
                <option value="unpublish">Не публиковать</option>
                <?php
                }else{ ?>
