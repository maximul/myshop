 ...
 <table class="form_table" width="940" border="0" cellspacing="0" cellpadding="2">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <input type="radio" name="ispublic" value="1" <?php echo $info['ispublic']?'checked="checked"':''; ?>><strong>Публичный</strong>
                <input type="radio" name="ispublic" value="0" <?php echo !$info['ispublic']?'checked="checked"':''; ?>><strong>Скрытый</strong>
        ...
        <tr>
            ...
            <td>
                <select name="manager_id">
                    ...
                    <option value="0" disabled="disabled">выберите начальника</option>
                    <?php
        ...
        <tr>
            <th colspan="2">
                <em><strong>Подпись отдела</strong>: Используется при исходящих письмах. &nbsp;<span class="error">&nbsp;<?php echo $errors['signature']; ?></span></em>
            </th>
        </tr>
        <tr>
            <td colspan=2>
