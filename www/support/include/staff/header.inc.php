...
<div id="container">
    ...
    ?>
    <div id="header">
        <a href="index.php" id="logo">osTicket.Ru - система управления заявками</a>
        <p id="info">Привет, <strong><?php echo $thisstaff->getUserName(); ?></strong>
           <?php
            if($thisstaff->isAdmin() && !defined('ADMINPAGE')) { ?>
            | <a href="admin.php">Настройки</a>
            <?php }else{ ?>
            | <a href="index.php">Заявки</a>
            <?php } ?>
            | <a href="profile.php">Профиль</a>
            | <a href="logout.php?auth=<?php echo $ost->getLinkToken(); ?>">Выход</a>
        </p>
    </div>
    <ul id="nav">
        <?php
