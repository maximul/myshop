...
<div style="float:right;text-align:right;padding-top:5px;padding-right:5px;">
    <b><a href="helptopics.php?a=add" class="Icon newHelpTopic">Добавить новую тему обращения</a></b></div>
<div class="clear"></div>
...
<input type="hidden" id="action" name="a" value="" >
 <table class="list" border="0" cellspacing="1" cellpadding="0" width="940">
    ...
    <thead>
        <tr>
            <th width="7">&nbsp;</th>        
            <th width="320"><a <?php echo $name_sort; ?> href="helptopics.php?<?php echo $qstr; ?>&sort=name">Тема обращения</a></th>
            <th width="80"><a  <?php echo $status_sort; ?> href="helptopics.php?<?php echo $qstr; ?>&sort=status">Статус</a></th>
            <th width="70"><a  <?php echo $type_sort; ?> href="helptopics.php?<?php echo $qstr; ?>&sort=type">Тип</a></th>
            <th width="100"><a  <?php echo $priority_sort; ?> href="helptopics.php?<?php echo $qstr; ?>&sort=priority">Приоритет</a></th>
            <th width="200"><a  <?php echo $dept_sort; ?> href="helptopics.php?<?php echo $qstr; ?>&sort=dept">Отдел</a></th>
            <th width="180" nowrap><a  <?php echo $updated_sort; ?>href="helptopics.php?<?php echo $qstr; ?>&sort=updated">Последнее обновление</a></th>
        </tr>
    </thead>
    <tbody>
    <?php
        ...
        if($res && db_num_rows($res)):
            ...
            <tr id="<?php echo $row['topic_id']; ?>">
                ...
                <td><?php echo $row['ispublic']?'Публичный':'<b>Приватный</b>'; ?></td>
...
<div style="display:none;" class="dialog" id="confirm-action">
    ...
    <p class="confirm-action" style="display:none;" id="enable-confirm">
        Вы уверены что хотите <b>включить</b> выбранные темы обращения?
    </p>
    <p class="confirm-action" style="display:none;" id="disable-confirm">
        Вы уверены что хотите <b>отключить</b> выбранные темы обращения?
    </p>
    <p class="confirm-action" style="display:none;" id="delete-confirm">
        <font color="red"><strong>Вы уверены что хотите УДАЛИТЬ выбранные темы обращения?</strong></font>
    </p>
    <div>Подтвердите действие для продолжения...</div>
