    ...
    <form action="staff.php" method="GET" name="filter">
     <input type="hidden" name="a" value="filter" >
        <select name="did" id="did">
             <option value="0">&mdash; все отделы &mdash;</option>
             <?php
        ...
        <select name="gid" id="gid">
            <option value="0">&mdash; все группы &mdash;</option>
             <?php
        ...
        <select name="tid" id="tid">
            <option value="0">&mdash; все команды &mdash;</option>
             <?php
...
<div style="float:right;text-align:right;padding-right:5px;"><b><a href="staff.php?a=add" class="Icon newstaff">Добавить пользователя</a></b></div>
<div class="clear"></div>
<?php
$res=db_query($query);
if($res && ($num=db_num_rows($res)))        
    ...
    $showing='Пользователи не найдены!';
?>
<form action="staff.php" method="POST" name="staff" >
 ...
 <table class="list" border="0" cellspacing="1" cellpadding="0" width="940">
    ...
    <thead>
        <tr>
            <th width="7px">&nbsp;</th>        
            <th width="200"><a <?php echo $name_sort; ?> href="staff.php?<?php echo $qstr; ?>&sort=name">Имя</a></th>
            <th width="100"><a <?php echo $username_sort; ?> href="staff.php?<?php echo $qstr; ?>&sort=username">Логин</a></th>
            <th width="100"><a  <?php echo $status_sort; ?> href="staff.php?<?php echo $qstr; ?>&sort=status">Статус</a></th>
            <th width="120"><a  <?php echo $group_sort; ?>href="staff.php?<?php echo $qstr; ?>&sort=group">Группа</a></th>
            <th width="150"><a  <?php echo $dept_sort; ?>href="staff.php?<?php echo $qstr; ?>&sort=dept">Отдел</a></th>
            <th width="100"><a <?php echo $created_sort; ?> href="staff.php?<?php echo $qstr; ?>&sort=created">Создан</a></th>
            <th width="145"><a <?php echo $login_sort; ?> href="staff.php?<?php echo $qstr; ?>&sort=login">Посл. вход</a></th>
        </tr>
    </thead>
    <tbody>
    <?php
        if($res && db_num_rows($res)):
            ...
            while ($row = db_fetch_array($res)) {
               ...
               <tr id="<?php echo $row['staff_id']; ?>">
                ...
                <td><?php echo $row['isactive']?'Активен':'<b>Заблокирован</b>'; ?>&nbsp;<?php echo $row['onvacation']?'<small>(<i>Отпуск</i>)</small>':''; ?></td>
...
<p class="centered" id="actions">
    <input class="button" type="submit" name="enable" value="Активировать" >
    &nbsp;&nbsp;
    <input class="button" type="submit" name="disable" value="Заблокировать" >
    &nbsp;&nbsp;
...
<div style="display:none;" class="dialog" id="confirm-action">
    ...
    <p class="confirm-action" style="display:none;" id="enable-confirm">
        Вы уверены что хотите <b>активировать</b> выбранных пользователей?
    </p>
    <p class="confirm-action" style="display:none;" id="disable-confirm">
        Вы уверены что хотите <b>заблокировать</b> выбранных пользователей?
    </p>
    <p class="confirm-action" style="display:none;" id="delete-confirm">
        <font color="red"><strong>Вы уверены что хотите УДАЛИТЬ выбранных пользователей?</strong></font>
    </p>
    <div>Для продолжения подверджите действие...</div>
