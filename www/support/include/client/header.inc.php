...
<head>
    ...
    <meta name="keywords" content="osTicket, техническая поддержка, система заявок, заявка, пподдержка, пользователь, проблема, Customer support system, support ticket system">
        ...
        <div id="header">
            ...
            <p>
             ...
             if($thisclient && is_object($thisclient) && $thisclient->isValid()) {
                ...
                <a href="<?php echo ROOT_PATH; ?>tickets.php">Мои заявки <b>(<?php echo $thisclient->getNumTickets(); ?>)</b></a> -
                <?php
                } ?>
                <a href="<?php echo ROOT_PATH; ?>logout.php?auth=<?php echo $ost->getLinkToken(); ?>">Выйти</a>
             <?php
             }elseif($nav){ ?>
                 <a href="<?php echo ROOT_PATH; ?>login.php">Войти</a>
              <?php
             } ?>
            </p>
        </div>
